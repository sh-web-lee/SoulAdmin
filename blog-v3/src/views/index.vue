...
function initTyped(input, fn, hooks) {
...
<template>
  <div class="w-screen h-screen overflow-hidden bg-[#000]">
    <div class="font">lee malachi Blog</div>
    <div class="absolute top-55% left-50% -translate-50% text-[#fff]">
      {{ obj.output }}
      <span class="blink relative -top-1px">|</span>
    </div>
