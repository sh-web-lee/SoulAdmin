...
<template>
  <div class="header_box order-0" :class="headerState.headerClass">
    <div class="pc_menu flex justify-between">
      <div class="sub-avatar">
        <router-link v-if="getBlogAvatar" to="/" class="font-bold text-20px decoration-none">lijianyang</router-link>
    ...
    <div class="mobile_menu flex justify-between">
      <div class="flex items-center">
