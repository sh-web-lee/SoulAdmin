...
const { login, register, updateOwnUserInfo, updatePassword, updateRole, getUserList, getUserInfo, getUserInfoById, adminUpdateUserInfo } = require("../controller/user");
...
const { tokenMiddleware } = require("../middleware/token/index")
...
// 获取用户个人信息
router.get("/getUserInfo", tokenMiddleware, getUserInfo)
// 用户修改个人用户信息
