    ...
    children: [
      {
        ...
        component: 'view.article_category',
        meta: {
          title: 'article_category',
          i18nKey: 'route.article_category',
      ...
      },
      {
        name: 'article_create',
        path: '/article/create',
        component: 'view.article_create',
        meta: {
          title: 'article_create',
          i18nKey: 'route.article_create',
          localIcon: 'nav-article-create'
        }
      },
      {
        name: 'article_info',
        path: '/article/info',
        component: 'view.article_info',
        meta: {
          title: 'article_info',
          i18nKey: 'route.article_info',
      ...
      },
      {
        name: 'article_manage',
        path: '/article/manage',
        component: 'view.article_manage',
        meta: {
          title: 'article_manage',
          i18nKey: 'route.article_manage',
      ...
      },
      {
        ...
        component: 'view.article_preview',
        meta: {
          title: 'article_preview',
          i18nKey: 'route.article_preview',
          icon: 'mage:preview-circle'
        }
      },
      {
        name: 'article_tags',
        path: '/article/tags',
        component: 'view.article_tags',
        meta: {
          title: 'article_tags',
          i18nKey: 'route.article_tags',
          icon: 'fa6-solid:tags'
        }
      }
    ]
    ...
    children: [
      {
        name: 'site_route',
        path: '/site/route',
        component: 'view.site_route',
        meta: {
          title: 'site_route',
          i18nKey: 'route.site_route',
