  ...
  page: {
    ...
    article: {
      ...
      create: {
        ...
        drawerTitle: '发布文章',
        description: '文章描述',
        descPlaceholder: '请输入文章描述',
        originUrlPlaceholder: '请输入原文链接',
        cover: '文章封面',
        saveButton: '保存',
        isTop: '是否置顶',
        categoryPlaceholder: '请选择文章分类',
        tagPlaceholder: '请选择文章标签或手动输入创建',
        status: '状态',
        type: '类型',
        origin_url: '原文链接'
      },
      ...
      site_info: {
        ...
        form: {
          ...
          notice: '公告',
          id: '',
          site_name_placeholder: '请输入网站名称',
          per_say_placeholder: '请输入个性签名',
          gitee_placeholder: '请输入gitee地址',
          github_placeholder: '请输入github地址',
